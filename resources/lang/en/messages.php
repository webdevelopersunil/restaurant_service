<?php return array(
        ...
        'record_not_deleted' => 'Record not found',
        'slider' => 'Slider',
        'assign' => 'Assign',
        'reason' => 'Reason',
        'favicon' => 'Favicon',
        ...
        'register_restaurant' => 'Registered successfully, A confirmation email has been sent to your registered email.',
        'register_provider' => 'Registered successfully, A confirmation email has been sent to your registered email.',
        'profile_update' => 'Profile has been successfully updated',

        'cancel_job_success'    => 'Job has been cancelled successfully',
        ...
        'referral' => 'Referral',
        'trade_education' => 'Trade education',
        ...
        'currency' => 'Currency',
        'bank_name' => 'Bank name',
        'restaurant_owner_users' => 'Restaurant Owner',
        ...
        'bar' => 'Bar on premise',
        'parking' => 'Parking on premise',
        'referred_by' => 'Referred by',
        'restaurant_address' => 'Restaurant address',
        'bio' => 'About',
        'provider_services' => 'Servces/Skills',
        'provider_documents' => 'Documents',
        'driver_license_front' => 'Driving license front',
        'driver_license_back' => 'Driving license back',
        'certification_license' => 'Certification/License number',
        'vehicle_license_plate' => 'Car/Truck license plate',
        'provider_documents' => 'Provider document',
        'cuisine' => 'Cuisine',
        'restaurant_type' => 'Type of restaurant',

        'unapproved_provider' => 'You are not approved',
        'already_applied' => 'You can not apply twice for same job',

        'unapproved_provider' => 'You are not approved',
        'already_applied' => 'You can not apply twice for same job',
        'maintanance_frequency_saved_successfully' => 'Maintanance Frequency saved successfully',
        'subscribed_successfully' => 'You has been subscribed successfully to selected plan',
        'list_of_equipments' => 'Equipment list',
        'refrigerant_type' => 'Refrigerant type',
        'equipment_number' => 'Equipment number',
        'model_number' => 'Model number',
        'warranty_info' => 'Warranty info',
        'voltage_amps' => 'Voltage amps',
        'sr_no' => 'Sr no',
        'list_of_team_members' => 'Team members list',
        'membership_plan_details' => 'Membership Plan Details',
        'subscription_status' => 'Subscription status',
        'expires_at' => 'Expires at',
        'equipment_category' => 'Category',
        'subscription_plan' => 'Subscription plan',
        'job_created' => 'Job has been Created Successfully',
        'data_retrieved_successfully'=>'Data retrieved successfully',
        'equipments' => 'View Equipments',
        'view' => 'View',
        'equipment' => 'Equipment',
        ...
        'equipment_upload_photo' => 'Upload Photo',
        'previous_photo' => 'Previous Photo',
        'offer_status_updated'=>'Offer status updated successfully',
        'request_was_unacceptable' => 'The request was unacceptable',
        'email_templates' => 'Email Template',
        'email_not_verified' => 'Your email verification is pending, Please verify your email.',
        'non_exist_error' => 'Provided data does not exist.',

        'provider_applied_job'=>'Job applied success',
        'ro_offer_sent'=>'Offer sent successfully',
        'not_valid_request'=>'Not valid request.',

        'not_nearby_of_job'=>'You are not nearby to start',
        'ratingCreated'=>'Rating has been created successfully',

        'provider_booking_list'=>'Provider booking list has been fetched successfully',
        'referredSuccess'=>'Restaurant referred successfully',
        'offer_has_been_sent_already'=>'Offer has been sent already',
    )
    ?>
