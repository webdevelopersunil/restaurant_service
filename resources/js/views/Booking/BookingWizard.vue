                            ...
                            <div class="row pt-4">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <vc-date-picker v-model="booking.date" mode="dateTime" is24hr required="required">
                        ...
                        <div class="card-body m-4">
                            ...
                            <div class="payment-info mt-5">
                                ...
                                <div class="bill-box">
                                    ...
                                    <span class="hightlight-text">{{ serviceData.price_format }} * {{ booking.quantity }} = <span v-if="currencyPostion === 'left'">{{currencySymobl}}</span>{{ parseFloat(serviceData.price * booking.quantity).toFixed(2) }}</span><span v-if="currencyPostion === 'right'">{{currencySymobl}}</span>
                                </div> 
                                <div  class="bill-box">
                                    <span class="text-secondary"><b>{{__('messages.tax')}}</b></span>
                                    <span class="text-danger"><span v-if="currencyPostion === 'left'">{{currencySymobl}}</span>{{parseFloat(taxfinal).toFixed(2)}}</span><span v-if="currencyPostion === 'right'">{{currencySymobl}}</span>
                                </div>
        ...
        <b-modal  ref="modal" id="coupons" header-bg-variant="primary" body-bg-variant="#f6f7f9" centered title="coupons" header-text-variant="white" title-class="text-white">
            <div class="row">
                ...
                <div class="col-6 mt-2  text center ">
                    <button type="button" @click="addCoupon" name="next" class="btn btn-primary w-100" value="Next" >{{__('messages.submit')}}</button>
                </div>
                <div class="col-6 mt-2  text center ">
