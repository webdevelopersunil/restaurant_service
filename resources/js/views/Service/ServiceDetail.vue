...
<div class="service-detail service-main mar-bot">
    <div class="service-image">
        <img v-if="serviceData.attchment_extension == true" :src="serviceData.attchments[0]"  alt="image" class="img-fluid">
        <div v-else class="player-container">
            <vue-core-video-player  :src="serviceData.attchments[0]" :cover="baseUrl+'/images/file.png'" :preload="'auto'"></vue-core-video-player>
        </div>
             ...
             <div class="row">
                <div class="col-lg-8">
                    <div class="service-detail-info">                                
                        ...
                        <div class="service-gallery service-top-space">
                            <div class="header-title-inner-page d-flex align-items-center justify-content-between">
                                <h4 class="title">{{__('messages.gallery')}}</h4>
                                <router-link :to="{ name: 'gallery', params: { galleryimg: serviceData.attchments,service_name:serviceData.name }}"  class="link-btn-box text-primary" ><span>{{__('messages.view_all')}}</span></router-link>
                            </div>   
