<x-master-layout>
@php
    $attachments = $bookingdata->service->getMedia('service_attachment');
    if(!$attachments->isEmpty()){
        $image = $attachments[0]->getFullUrl();
    } else {
        $image = getSingleMedia($bookingdata->service,'service_attachment');
    }
@endphp
                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th rowspan="6" class="responsive-hide"></th>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">{{!empty($bookingdata->total_amount) ? getPriceFormat($bookingdata->total_amount): 0}}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
